...
export const metadata: Metadata = {
  title: { absolute: "개인정보처리방침 | 설교가이드" },
  description: "설교가이드가 처리하는 정보와 이용 목적, 저장 위치 및 이용자 선택권을 안내합니다.",
...
const sections: readonly LegalSection[] = [
    ...
    content: (
      <>
        <p>
          ...
          설교가이드 웹 서비스에 적용됩니다. 설교가이드는 서비스 제공에 필요한
          범위에서 정보를 처리하고, 광고 판매를 목적으로 개인정보를 처리하지 않습니다.
        </p>
        <p>
          아래 내용은 현재 서비스에서 실제로 제공하는 회원 인증, 설교 생성·저장,
          전문가 상담, 알림 설정, 관리자 AI 엔진 설정 및 토큰 충전 기능을 기준으로 합니다.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            비밀번호 인증은 Supabase Auth가 담당하며, 설교가이드의 앱 데이터베이스에는
            원문 비밀번호를 저장하지 않습니다.
          </li>
        </ul>
        ...
        <ul>
          <li>
            설교 주제, 성경 본문, 설교 유형, 대상, 분량, 대지 수, 정서적 톤과 수정 지시
          </li>
        ...
        <h3>전문가 상담</h3>
        <ul>
          <li>상담을 신청한 설교, 상담 사유, 배정 상태와 대기 순서</li>
          <li>상담 참여자의 이름·역할, 상담 메시지, 언급한 원고 구간과 작성 시각</li>
        </ul>
        ...
        <ul>
          ...
          <li>카드 번호와 CVC 같은 결제수단 원문 정보는 설교가이드가 직접 저장하지 않습니다.</li>
        </ul>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          설정, 설교와 상담 기록은 서비스에 연결된 <strong>Supabase PostgreSQL</strong>
          데이터베이스에 저장될 수 있습니다.
        </p>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            <strong>AI 제공자:</strong> 서버 관리형 OpenAI 또는 이용자가 직접 선택한
            OpenAI, Anthropic, Google Gemini, OpenRouter, 공개 HTTP·HTTPS 호환 API에 설교
            조건·본문·참고 자료·수정 지시와 API 키를 전송
          </li>
          <li>
            <strong>상담 전문가:</strong> 대기 중인 상담을 검토하는 전문가는 요청자 이름,
            설교 제목, 신청 사유와 상태를 볼 수 있고, 배정된 뒤에만 설교 원문과 상담
            메시지를 열람할 수 있습니다.
          </li>
        </ul>
        <p>
          특히 사용자가 직접 지정하는 호환 AI API의 운영자와 처리 조건은 설교가이드가
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          계정, 프로필, 설정, 토큰·결제 원장, 서버에 저장한 설교와 상담 기록에는 현재 별도의 자동 삭제
  ...
  },
  {
    ...
    content: (
      <>
        <ul>
          <li>내 정보에서 표시 이름, 사역 역할과 교회 이름을 확인·수정할 수 있습니다.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          설교가이드는 Supabase 세션 검증, 계정별 데이터 접근 확인과 데이터베이스의 행 수준
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          <strong>시행일:</strong> 2026년 8월 17일
        </p>
      </>
    ),
  },
...
export default function PrivacyPage() {
  return (
    <LegalDocument
      ...
      title="개인정보처리방침"
      summary="설교가이드가 어떤 정보를 왜 처리하는지, 어디에 저장되는지, 이용자가 무엇을 선택할 수 있는지 안내합니다."
